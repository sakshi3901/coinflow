...
export default function Homepage() {
    return (<div className="flex w-full max-w-5xl flex-col items-center">
        ...
        <div className="grid grid-cols-3">
            ...
            {/* Glass Card */}
            <div onClick={() => window.location.href = '/chart'} className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_20px_80px_-20px_rgba(168,85,247,0.35)] p-6 hover:scale-[1.02] transition">
